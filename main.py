...
# Options for filter_name: 'mean', 'median', 'kalman' | use raw data: 'nofilter'
# filter_name = "mean"
# filter_name = "median"
# filter_name = "kalman"
...
def main():
    ...
    if ifDoAnalysis:
        ...
        class_num = 4 # option: 2 (normal/abnormal), 3 (high/moderate/low aggression), 4 (bite/chase/display/normal)

        # Options for model_name: 'SVM', 'RandomForest', 'XGBoost'
        model_name = "SVM"  
